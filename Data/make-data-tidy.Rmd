...
```{r, echo=FALSE}
# Bruk heller regexp, virker på alle, ikke bare de 10 i eksemplet
my_pat <- "\\s*\\([-\\d]+\\)\\s*"
...
# Fjern (-2019) etc
# arblos_aldersgrp$knavn <- str_remove(arblos_aldersgrp$knavn, pattern = fixed(" (-2019)"))
# arblos_aldersgrp$knavn <- str_remove(arblos_aldersgrp$knavn, pattern = fixed(" (1992-2019)"))
# arblos_aldersgrp$knavn <- str_remove(arblos_aldersgrp$knavn, pattern = fixed(" (1994-2019)"))
```
...
```{r, echo=FALSE}
#mye mindre arbeid og i tillegg riktig svar
