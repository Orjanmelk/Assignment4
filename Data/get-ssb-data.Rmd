...
Data sist hentet 09. desember 2020. Dette dokumentet skal bare kjøres hvis nye data må hentes inn. `eval = FALSE` over i setup chunk må endres til `eval = TRUE`, så må setup chunk-en kjøres før en til slutt velger  `Restart R and run all chunks` fra `Run` menyen.
